...
class BertAttention(nn.Module):
    ...
    def forward(self, input_tensor_query, input_tensor, attention_mask_query, attention_mask):
        """
        Args:
            input_tensor: (N, L, D)
            attention_mask: (N, L)
        """
        self_output = self.self(input_tensor, input_tensor, input_tensor, attention_mask_query, attention_mask)
        attention_output = self.output(self_output, input_tensor_query)
