...
def get_train_data_loaders(cap_files, visual_feats, batch_size=100, num_workers=2, n_caption=2, video2frames=None):
    """
    ...
    """
    dset = {'train': Dataset4DualEncoding(cap_files['train'], visual_feats['train'],  video2frames=video2frames['train'])}
