...
def build_vocab(cap_file, text_style, threshold=4, rootpath=ROOT_PATH):
...
def main(option):
    ...
    vocab, word_counter = build_vocab(cap_file, text_style, threshold=threshold, rootpath=rootpath)
